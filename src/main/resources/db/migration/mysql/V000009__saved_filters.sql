...
--  single-letter abbreviations, never 2-4 letter truncations вЂ”
...
--  serialised text.
--
--  What is stored is the PREDICATE вЂ” `issue.assignee == currentMember` вЂ” and never
...
--  SQL вЂ” the same reasoning as V000008's service-enforced sprint invariants.
--
...
--  which is precisely what makes them universal. Nothing else may leave them null вЂ”
...
-- project shares вЂ” this index serves both halves of that read. Global presets carry
