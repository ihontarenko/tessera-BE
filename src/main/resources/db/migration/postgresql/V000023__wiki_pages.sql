...
--
--  ⚠️ NOT byte-identical to the mysql copy: `content_markdown` is TEXT here and
--  MEDIUMTEXT there. MySQL's TEXT holds 65535 BYTES, which under utf8mb4 is
...
(
    ...
    -- The only copy of the text. PostgreSQL's TEXT is unbounded, so unlike the
    -- mysql copy this needs no wider type — see the header, which also says why
